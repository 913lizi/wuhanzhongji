    ...
    function(e) {
        ...
        var t = layui.$,
            ...
            c = function() {
                var e = this,
                    t = e.config,
                    i = t.id || t.index;
                return i && (c.config[i] = t, c.that[i] = this),
                {
                    reload: function(t) {
                        e.reload.call(e, t)
                    },
        ...
        j.prototype.config = {
                        ...
                        function(e, a) {
                            layui.each(a,
                                function(l, n) {
                                    ...
                                    if (n.key = e + "-" + l, n.hide = n.hide && n.hideable !== !1 || !1, n.colGroup || n.colspan > 1) {
                                        var o = 0;
                ...
                r(),
                    ...
                    e.eachCols(function(i, a) {
                        ...
                        a.colGroup || a.hide || (0 === a.width ? e.getCssRule(t.index + "-" + a.key,
                            ...
                            }) : a.widthChange && (delete a.widthChange, e.getCssRule(t.index + "-" + a.key,
                            function(e) {
            ...
            j.prototype.pullData = function(e) {
                ...
                if (i.startTime = (new Date).getTime(), i.setColsWidth(), a.url) {
                    var r = {};
                    r[l.pageName] = e,
                        ...
                        t.ajax({
                            ...
                            success: function(t) {
                                "function" == typeof a.parseData && (t = a.parseData(t) || t),
                                    t[n.statusName] != n.statusCode ? (i.renderForm(), t[n.dataName] = [], i.renderData(t, e, t[n.countName]), o(), i.layMain.find("." + y).html(t[n.msgName] || "返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode)) : (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"),
                                    i.setColsWidth(),
                                    i.loading(!0),
                            ...
                            error: function(e, t) {
                                ...
                                a[n.dataName] = [],
                                    i.renderData(a, 1, 0),
                                    o(),
                                    i.layMain.find("." + y).html("数据接口请求异常：" + t),
                                    i.renderForm(),
                                    i.setColsWidth(),
                                    i.loading(!0)
                            }
                            ...
                            function(a, l) {
                                ...
                                0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function(n, r) {
                                    ...
                                    if (void 0 !== p && null !== p || (p = ""), !r.colGroup) {
                                        ...
                                        "right" === r.fixed && y.push(v)
                                    }
                                }), f.push('<tr data-index="' + a + '">' + o.join("") + "</tr>"), p.push('<tr data-index="' + a + '">' + u.join("") + "</tr>"), v.push('<tr data-index="' + a + '">' + y.join("") + "</tr>"))
                            }), c.layBody.scrollTop(0), u.length && c.layMain.find("." + y).remove(), c.layMain.find("tbody").html(f.join("")), c.layFixLeft.find("tbody").html(p.join("")), c.layFixRight.find("tbody").html(v.join("")), c.renderForm(), "number" == typeof e && c.setThisRowChecked(e), c.syncCheckAll(), c.scrollPatch(), l.close(c.tipsIndex), s.HAS_SET_COLS_PATCH || c.setColsPatch(), void(s.HAS_SET_COLS_PATCH = !0))
                    };
                return c.key = s.id || s.index,
                    d.cache[c.key] = u,
                    c.layPage[0 == o || 0 === u.length && 1 == n ? "addClass": "removeClass"](h),
                    r ? m() : (m(), 0 === u.length ? (c.renderForm(), c.layMain.find("tbody").html(""), c.layTotal.addClass(h), c.layMain.find("." + y).remove(), c.layMain.append('<div class="' + y + '">' + s.text.none + "</div>")) : (c.renderTotal(u), void(s.page && (s.page = t.extend({
            ...
            j.prototype.renderTotal = function(e) {
                var t = this,
                    i = t.config,
                    a = {};
                if (t.layTotal[i.totalRow && e.length ? "removeClass": "addClass"](h), i.totalRow) {
                    layui.each(e,
                        function(e, i) {
                    ...
                    t.eachCols(function(e, n) {
                        var o = n.field || e;
                        if (!n.hide) {
                            var r = ['<td data-field="' + o + '" data-key="' + t.index + "-" + n.key + '" ' +
                            function() {
                                var e = [];
            ...
            j.prototype.sort = function(e, i, a, l) {
                ...
                i && ["asc", "desc"].indexOf(i) !== -1 || delete c.sortKey,
                    "server" === h.sortType && h.url ? (u[h.response.dataName] = f, l || c.renderData(u, c.page, c.count, !0)) : (r = "asc" === i ? layui.sort(f, n) : "desc" === i ? layui.sort(f, n, !0) : layui.sort(f, d.config.indexName), u[h.response.dataName] = r, c.renderData(u, c.page, c.count, !0)),
                l && layui.event.call(e, s, "sort(" + y + ")", {
                    field: n,
                    type: i
                })
            },
            ...
            j.prototype.scrollPatch = function() {
                ...
                e.layFixed.find(b).css("height", i.height() > d ? d: "auto"),
                    e.layFixRight[n > 0 ? "removeClass": "addClass"](h),
                        ...
                        switch (layui.stope(e), H.trigger("table.tool.panel.remove"), l.close(a.tipsIndex), c) {
                            case "LAYTABLE_COLS":
                                u({
                                    list:
                                        function() {
                                            var e = [];
                                            return a.eachCols(function(i, a) {
                                                a.field && "normal" == a.type && e.push('<li><input type="checkbox" name="' + a.field + '" data-key="' + a.key + '" data-parentkey="' + (a.parentKey || "") + '" lay-skin="primary" ' + (a.hide ? "": "checked") + ' title="' + (t(a.title).length ? t(a.title).text() || a.field: a.title || a.field) + '" lay-filter="LAY_TABLE_TOOL_COLS" ' + (a.hideable === !1 ? "disabled": "") + "></li>")
                                            }),
                                                e.join("")
                                        } (),
                                    done: function() {
                                                        ...
                                                        layui.each(t,
                                                            function(t, i) {
                                                                if (e + "-" + t === n) {
                                                                    var d = i.hide;
                                                                    i.hide = !l,
                                                                        a.elem.find('*[data-key="' + o.index + "-" + n + '"]')[l ? "removeClass": "addClass"](h),
                            ...
                            case "LAYTABLE_PRINT":
                                ...
                                v.append(a.layMain.find("table").html()),
                                    ...
                                    y.document.write(f + v.prop("outerHTML")),
                                    y.document.close(),
                                    y.print(),
                                    y.close()
                        }
                ...
                a.elem.on("click", 'input[name="layTableCheckbox"]+',
                    function() {
                        ...
                        o ? (i.each(function(e, t) {
                            ...
                            layui.event.call(e[0], s, "checkbox(" + p + ")", v.call(e[0], {
                                checked: n,
                                type: o ? "all": "one"
                            }))
                    }),
                    ...
                    a.layBody.on("mouseenter", "tr",
                        function() {
                            var e = t(this),
                                i = e.index();
                            a.layBody.find("tr:eq(" + i + ")").addClass(S)
                        }).on("mouseleave", "tr",
                        function() {
                            var e = t(this),
                                i = e.index();
                            a.layBody.find("tr:eq(" + i + ")").removeClass(S)
                        }).on("click", "tr",
                        function() {
                            m.call(this, "row")
                        }).on("dblclick", "tr",
            ...
            d.dataParams = ["url", "method", "where", "contentType", "headers", "parseData", "request", "response", "data", "page"],
            d.reload = function(e, i) {
                var a = this,
                    l = !0,
                    n = c.config[e];
                if (i = i || {},
                        !n) return o.error("The ID option was not found in the table instance");
                if (i.data && i.data.constructor === Array && delete n.data, layui.each(i,
                        function(e, t) {
                            if (a.dataParams.indexOf(e) === -1) return l = !1,
                                !0
                        }), l) {
                    var r = c.that[e];
                    return "object" == typeof i.page && (i.page.curr && (r.page = i.page.curr), delete i.page.elem, delete i.page.jump),
                        t.extend(!0, n, i),
                    n.page || (r.page = 1),
                        r.loading(),
                        r.pullData(r.page),
