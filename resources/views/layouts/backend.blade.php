...
//    $permission = (!$permission->isEmpty()) ? $permission->toArray() : [];
...
<head>
    <meta charset="utf-8" />
    <title>Nymco Admin | Dashboard</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar">
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li><a style="cursor:pointer"  onclick="jump('{{ url('/admin/dashboard')}}')"><i class="material-icons">home</i><span>Dashboard</span></a></li>
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a style="cursor:pointer" onclick="jump('{{ url('/admin/web/webType')}}')" href="javascript:void (0);">网站类型设置</a></li>
    ...
    <div style="margin-left: 15px;">
        <iframe  style="width: 100%;min-height: 820px;"  id="iframe-content" src="{{ url('/admin/dashboard') }}" height="100%" frameborder="0" style="overflow-x:scroll"></iframe>
    </div>
    <!-- begin theme-panel -->
...
<script>
    $(document).ready(function() {
        App.init();
        $('[data-click=sidebar-minify]').click(function(){
            $('#iframe-content')[0].contentWindow.mini();
        });
    });
